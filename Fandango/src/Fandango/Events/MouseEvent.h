...
namespace Fandango
{
	class FNDG_API MouseMovedEvent : public Event
	{
	public:
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "MouseWheelScrolledEvent: " << GetXOffset() << ", " << GetYOffset();
			return ss.str();
		}
	...
	class FNDG_API MouseButtonEvent : public Event
	{
	public:
	...
	class FNDG_API MouseButtonPressedEvent : public MouseButtonEvent
	{
	public:
	...
	class FNDG_API MouseButtonReleasedEvent : public MouseButtonEvent
	{
	public:
